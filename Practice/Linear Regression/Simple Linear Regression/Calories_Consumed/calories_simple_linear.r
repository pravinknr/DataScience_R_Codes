...
sd(calories$Weight.gained..grams.) #Gives the Standard DEviation of the Column
sd(calories$Calories.Consumed)

var(calories$Weight.gained..grams.) #Gives the Variance of the Column
...
calorie_sqrt_model <- lm(calories$Weight.gained..grams.~. , data = sqrt(calories))
...
#log transformation
calorie_log_model <-lm(log(calories$Weight.gained..grams.)~.,data=calories)
